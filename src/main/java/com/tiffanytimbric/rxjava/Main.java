 ...
 * <ul>
 *     <li>Push - New data arrives asynchronously until the publisher signals its end.
 *                The subscriber process the incoming data as it arrives.  This flow
 *                type is alloigous to event stream, event processing.</li>
 *     <li>Pull - A fixed block of data pre-exists before the processing of it begins.
